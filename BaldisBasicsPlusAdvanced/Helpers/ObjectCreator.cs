...
namespace BaldisBasicsPlusAdvanced.Helpers
{
    public class ObjectCreator
    {
        ...
        public static StandardMenuButton AddButtonProperties(TMP_Text text, bool underlineOnHighlight = false)
        {
            ...
            parent.layer = LayerHelper.ui;
            parent.tag = "Button";
            parent.transform.SetParent(text.transform.parent);
            parent.transform.position = text.transform.position;

            parent.gameObject.AddComponent<Image>().sprite = AssetStorage.sprites["transparent"];
        ...
        public static StandardMenuButton AddButtonProperties(TMP_Text text, Vector2 sizeDelta, bool underlineOnHighlight = false)
        {
            ...
            image.sprite = AssetStorage.sprites["transparent"];
        ...
        public static SpriteRenderer CreateSpriteRenderer(Sprite sprite, bool isBillboard = true)
        {
            ...
            spriteRenderer.gameObject.layer = LayerHelper.billboard;

            if (isBillboard)
            {
                spriteRenderer.material = new Material(AssetStorage.materials["sprite_standard_billboard"]);
            }
            else
                spriteRenderer.material = new Material(AssetStorage.materials["sprite_standard_no_billboard"]);
        ...
        {
            CoverCloud chalkCloud = UnityEngine.Object.Instantiate(AssetStorage.coverCloud);
        ...
        public static MeshRenderer CreateQuadRenderer()
        {
            ...
            meshRenderer.material = new Material(AssetStorage.materials["belt"]);
