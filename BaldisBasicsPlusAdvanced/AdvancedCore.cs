...
namespace BaldisBasicsPlusAdvanced
{
    ...
    public class AdvancedCore : BaseUnityPlugin
    {
        ...
        public const string version = "0.2.2.5";
        ...
        //internal static Dictionary<string, string> keyBindings = new Dictionary<string, string>();
        ...
        {
            UnityWebRequest webRequest = UnityWebRequest.Get("https://api.gamebanana.com/Core/Item/Data?itemtype=Mod&itemid=504169&fields=Updates().aGetLatestUpdates()");
