...
{
    internal class ExtraSettingsManager
    {
        ...
        // 1f, 1.01f, 2f
        // 3f - dictionary instead of many fields + a new way of serialization
        // 4f - tips during level option removed, added legacy elevator
        private const float extraSettingsVersion = 4f;
        ...
        public static void Save()
        {
            if (extraSettings != null)
            {
                ...
                File.WriteAllText(SaveSystemCore.Path + extraSettingsFile, 
                    RijndaelEncryption.Encrypt(JsonConvert.SerializeObject(extraSettings), keyAccess));
            }
        }
    }
}
