    ...
    public class LevelLoaderIntegration
    {
        ...
        public static void Initialize()
        {
            ...
            PlusLevelLoaderPlugin.Instance.roomSettings.Add("adv_advanced_class", new RoomSettings(
                EnumExtensions.GetFromExtendedName<RoomCategory>("AdvancedClass"),
                RoomType.Room,
            ...
            PlusLevelLoaderPlugin.Instance.roomSettings["adv_school_council_class"].container = ObjectsStorage.RoomFunctionsContainers["CorruptedLightsFunction"];
