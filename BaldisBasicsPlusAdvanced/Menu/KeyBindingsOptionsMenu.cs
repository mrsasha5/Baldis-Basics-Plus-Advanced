...
namespace BaldisBasicsPlusAdvanced.Menu
{
    public class KeyBindingsOptionsMenu : CustomOptionsCategory
    {
        ...
        public override void Build()
        {
            ...
            List<KeyBindingData> bindings = OptionsDataManager.KeyBindings.Values.ToList();
            ...
            if (keyButtons.Count > 0)
            {
                CreateTextButton(delegate
                {
                    ...
                    OptionsDataManager.SetBindingDefaultValues();
                    OptionsDataManager.RewriteBindings();
        ...
        {
            CoreGameManagerPatch.SetPauseDisable(true);
        ...
        private IEnumerator Waiter(StandardMenuButton button, KeyBindingData data)
        {
            ...
            */
            ...
            CoreGameManagerPatch.SetPauseDisable(false);
