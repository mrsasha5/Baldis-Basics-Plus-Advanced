...
namespace BaldisBasicsPlusAdvanced.Menu
{
    public class ExtraOptionsMenu : CustomOptionsCategory
    {
        ...
        public override void Build()
        {
            ...
            MenuToggle tipsDuringGameToggle = CreateSynchronizatedToggleButton(
                synchronizableName: "tips_during_game",
                nameKey: "Adv_Option_Tips_During_Game",
                descKey: PlayerDataManager.Data.gameWins >= 10 ? "Adv_Option_Tips_During_Game_Desc" :
                    "Adv_Option_Tips_During_Game_Locked_By_Wins_Desc",
                pos: new Vector3(70f, -5f, 0f),
                width: 250f,
                setDisabledCover: true
            );
            tipsDuringGameToggle.GetComponentInChildren<MenuButton>()
                .OnPress.AddListener(delegate { DisableToggleOnPress(tipsDuringGameToggle); });
            tipsDuringGameToggle.Disable(gameInitialized);
