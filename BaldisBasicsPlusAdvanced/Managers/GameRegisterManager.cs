...
using BaldisBasicsPlusAdvanced.Compats.Extra.Patches.Game.Player;
...
namespace BaldisBasicsPlusAdvanced.Managers
{
    public class GameRegisterManager
    {
        ...
        public static void InitializeButtonColors()
        {
            ButtonColorManager.CreateButtonMaterial("adv_generic_button_orange", new Color(1f, 0.4f, 0f)); //orange
            ButtonColorManager.CreateButtonMaterial("adv_generic_button_pink", new Color(1f, 0f, 1f)); //pink
            ButtonColorManager.CreateButtonMaterial("adv_generic_button_gray", Color.gray); //gray
        }
        ...
        public static void InitializeObjectBuilders()
        {
            ...
            PrefabsCreator.CreateStructureBuilder<Structure_Zipline>("Structure_Zipline")
                .SetStructureParameters(floor: 2, new StructureParameters()
                {
                    //minMax = new IntVector2[] { new IntVector2(2, 5), new IntVector2(0, 3) },
        ...
        public static void InitializeObjects()
        {
            ...
            mathMachineComp = GameObject.Instantiate(AssetsHelper.LoadAsset<MathMachine>("MathMachine"));
            ...
            symbolMachine.InitializePrefab(1);
        ...
        public static void SetTags()
        {
            ...
            SetTagsTo(new string[] { "adv_forbidden_present" },
                Items.BusPass);
        ...
        public static void InitializeRoomAssets()
        {
            ...
            foreach (string path in filesPath)
            {
                ...
                RoomAsset roomAsset = RoomHelper.CreateAssetFromPath(path, roomData.isOffLimits, roomData.autoAssignRoomFunctionContainer,
                    null, isAHallway: roomData.isAHallway, keepTextures: roomData.keepTextures);
