...
namespace BaldisBasicsPlusAdvanced.Game.Builders
{
    public class Structure_GumDispenser : StructureBuilder, IPrefab
    {
        ...
        [SerializeField]
        private string buttonsMaterialsName;
        ...
        public void InitializePrefab(int variant)
        {
            ...
            buttonsMaterialsName = "adv_generic_button_pink";
        ...
        public bool BuildDispenser(LevelGenerator lg, Cell cell, Direction dir)
        {
            ...
            GameButton button = GameButton.BuildInArea(ec, cell.position, cell.position, buttonRange, dispenser.gameObject,
                WeightedGameObject.ControlledRandomSelection(buttonsPre, lg.controlledRNG).GetComponent<GameButton>(), lg.controlledRNG);

            if (button != null)
            {
                button.ChangeColor(buttonsMaterialsName);
