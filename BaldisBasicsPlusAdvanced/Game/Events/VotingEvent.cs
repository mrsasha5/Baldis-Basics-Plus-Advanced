    ...
    public class VotingEvent : RandomEvent, IPrefab
    {
        ...
        public void InitializePrefab(int variant)
        {
            ...
            while (File.Exists(path + "VotingRoom" + n + ".cbld"))
            {
                ...
                RoomHelper.SetupRoomFunction<DisabledPowerOnGenerationFinishedFunction>(weightedRoom.selection.roomFunctionContainer);
                RoomHelper.SetupRoomFunction<SchoolCouncilFunction>(weightedRoom.selection.roomFunctionContainer);
                //LockedDoorsFunction lockedDoorsFunc = 
                    //RoomHelper.SetupRoomFunction<LockedDoorsFunction>(weightedRoom.selection.roomFunctionContainer);
                //lockedDoorsFunc.SetLockedDoors(true);
                //lockedDoorsFunc.SetAutoUpdate(true);
                ...
                //weightedRoom.selection.doorMats = AssetsHelper.LoadAsset<StandardDoorMats>("SchoolCouncilDoorSet");
