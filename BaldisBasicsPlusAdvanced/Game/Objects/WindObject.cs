...
namespace BaldisBasicsPlusAdvanced.Game.Objects
{
    public class WindObject : MonoBehaviour
    {
        ...
        public PropagatedAudioManager AudMan => audMan;
...
//Bad way of fixing, but what else? Are you thinking of creating own wind is better? Or worse: patching conveyor Update method?
            beltManager.SetRunning(false);
            ...
            audMan = beltManager.GetComponentInChildren<PropagatedAudioManager>();

            audMan.Pause(pause: false);
        ...
        protected virtual void VirtualUpdate()
        {
            ...
            {
                beltManager.SetAnyDirection(parent.forward);
