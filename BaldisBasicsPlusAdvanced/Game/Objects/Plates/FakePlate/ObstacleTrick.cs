...
namespace BaldisBasicsPlusAdvanced.Game.Objects.Plates.FakePlate
{
    ...
    public class ObstacleTrick : BaseTrick
    {
        ...
        public override bool IsSelectable()
        {
            ...
            if (cell != null)
            {
                return base.IsSelectable() && (cell.shape == TileShapeMask.Corner || cell.shape == TileShapeMask.Straight);
            }
            return false;
        }
        ...
        public override void Reset()
        {
            ...
            if (cell == null) return;
            foreach (Cell cell in Plate.Ec.GetCellNeighbors(cell.position))
            {
