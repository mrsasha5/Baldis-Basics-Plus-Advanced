...
{
    // In general don't like how the game is implemented EntityPull
    public class CustomEntityPull : MonoBehaviour
    {
        public delegate void OnEntityCatched(EntityPullingData entityData);

        public class EntityPullingData
        {
            private CustomEntityPull pull;
            ...
            public EntityPullingData(CustomEntityPull pull)
            {
                this.pull = pull;
            }
