...
namespace BaldisBasicsPlusAdvanced.Game.Rooms.Functions
{
    public class CorruptedLightsFunction : RoomFunction
    {
        ...
        public override void OnGenerationFinished()
        {
            ...
            if (!ControlledRNG.GenAvailable) return;
            ...
            {
                targetedCells.Add(potentialTargets[ControlledRNG.Object.Next(0, potentialTargets.Count)]);
            }
        ...
        private void Update()
        {
            if (time > 0f && blinks <= 0 && targetedCells.Count > 0)
            {
