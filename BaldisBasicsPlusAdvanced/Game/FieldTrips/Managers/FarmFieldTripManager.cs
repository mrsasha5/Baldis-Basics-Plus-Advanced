...
namespace BaldisBasicsPlusAdvanced.Game.FieldTrips.Managers
{
    public class FarmFieldTripManager : BaseFieldTripManager, IPrefab
    {
        ...
        public void SpawnBaldi()
        {
            ...
            {
                ReflectionHelper.SetValue<float>(baldi.behaviorStateMachine.currentState, "delayTimer", 0f);
            }
        }
        ...
        private void GiveRewards()
        {
            ...
            RoomController room = GameObject.FindObjectOfType<FieldTripEntranceRoomFunction>(true).Room;
        ...
        private IEnumerator MazeGenerator()
        {
            ...
            {
                return ec.ContainsCoordinates(x, z) && ec.CellFromPosition(x, z).room == room;
            }
