...
namespace BaldisBasicsPlusAdvanced.Game.FieldTrips
{
    public class FieldTripsLoader
    {
        ...
        {
            fieldTripLoadingScreen = GameObject.Instantiate(
            ...
            foreach (SwingDoor door in GameObject.FindObjectsOfType<SwingDoor>(true))
            {
                if (door.open) door.Shut();
            }

            foreach (StandardDoor door in GameObject.FindObjectsOfType<StandardDoor>(true))
            {
                if (door.open) door.Shut();
            }
        ...
        public static void OnTripReady()
        {
            ...
            GameObject.Destroy(fieldTripLoadingScreen.gameObject);
            GameObject.FindObjectOfType<BaseFieldTripManager>().OnLoadingScreenDestroying();
        }
